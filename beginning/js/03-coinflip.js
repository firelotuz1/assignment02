...
// variables, prompts, conditionals, operators, math, and more to create a 
// “coin flip game”. To complete the game follow the steps outlined below:
// 1.	Begin your application by creating a variable called coinFlip and 
// set it equal to a random number. You will have to use a Math method to get this 
// number:
